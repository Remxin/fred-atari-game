        ...
        this.breakPoints = [ // TODO: smaller range breakpoints
            {
                ...
                platforms: [],
                enemies: [],
                neutral: [new Vase(-100, 55), new Vase(-150, 55), new Vase(-200, 55), new Vase(-250, 55), new Vase(-300, 55)],
                decorations: []
            },
            {   
                ...
                neutral: [ new Vase(400, 56), new PickableStone(550, 30), new Grass(0, 60, "l", false)],
                decorations: []
            },
            {
